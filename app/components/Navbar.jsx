    ...
    <>
      <div className="z-50 w-full left-0 top-0 fixed">
        <div className="w-full h-[70px] flex items-center ">
          <div className="w-full bg-black/5 backdrop-blur-sm max-w-[100%] md:max-w-full mx-auto flex items-center justify-between py-4 px-5 rounded-2xl">
            {/* Logo */}
            ...
            <button
              ...
              className="lg:hidden text-black text-3xl z-30"
            >
              {menuOpen ? <X /> : <Menu />}
            </button>
            ...
            >
              ...
              >
                ...
                {curriculumOpen && academicOpen && (
                  ...
                  >
                    <Link
                      href="/academic/curriculum/board"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Board
                    </Link>
                    <Link
                      href="/academic/curriculum/boardspecial"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Board Special
                    </Link>
                    ...
                    <Link
                      href="/academic/curriculum/hifz"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Hifz
                    </Link>
                    <Link
                      href="/academic/curriculum/nazera"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Nazera
                    </Link>
                    <Link
                      href="/academic/curriculum/kitab"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Kitab
                    </Link>
                ...
                {routineOpen && academicOpen && (
                  ...
                  >
                    <Link
                      href="/academic/routine/board"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Board
                    </Link>
                    <Link
                      href="/academic/routine/boardspecial"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Board Special
                    </Link>
                    <Link
                      href="/academic/routine/nazera"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Nazera
                    </Link>
                    <Link
                      href="/academic/routine/hifz"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Hifz
                    </Link>
                    <Link
                      href="/academic/routine/advice"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Advice
                    </Link>
                    <Link
                      href="/academic/routine/kitab"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Kitab
                    </Link>
                    <Link
                      href="/academic/routine/thursday-friday"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Thursday & Friday
                    </Link>
                    <Link
                      href="/academic/routine/mamulat"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Daily Mamulat
                    </Link>
                ...
                {servicesOpen && academicOpen && (
                  ...
                  >
                    <Link
                      href="/serviceses/free-food-numbers"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Free Food
                    </Link>
      ...
      Help Centre
              ...
              >
                ...
                {admissionOpen && (
                  ...
                  >
                    <Link
                      href="/admission/admission-numbers"
                      className="block px-4 py-2 hover:bg-white/10"
                    >
                      Admission Numbers
                    </Link>
